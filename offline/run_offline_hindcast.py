...
Usage (from project root, inside container or native env):
  python offline/run_offline_hindcast.py \\
      "2025-10-10 01:00" "2025-10-10 01:00" --regions Antigua

Or via launcher:
  TITO_RUNTIME=apptainer ./tito-run.sh hindcast "..." "..." --regions Antigua --offline
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--regions", default="Antigua")
